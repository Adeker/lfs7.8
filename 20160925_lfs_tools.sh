...
mkdir -v /mnt/lfs/note
chmod -v a+wt /mnt/lfs/note
cd /mnt/lfs/note
...
wget http://www.linuxfromscratch.org/lfs/downloads/7.8/LFS-BOOK-7.8.tar.bz2
tar -xf LFS-BOOK-7.8.tar.bz2
wget http://ftp.lfs-matrix.net/pub/lfs/lfs-packages/lfs-packages-7.8.tar --continue --directory-prefix=$LFS/sources
wget http://ftp.lfs-matrix.net/pub/lfs/lfs-packages/MD5SUMS --continue --directory-prefix=$LFS/sources
...
tar -xf lfs-packages-7.8.tar

mkdir $LFS/sources/lfsbak
cp -v MD5SUMS lfsbak/
cp -v lfs-packages-7.8.tar lfsbak/
rm MD5SUMS lfs-packages-7.8.tar
cp -v 7.8/* .
rm -rf 7.8/
